...
func registerAPIRoutes(r *gin.RouterGroup, h *ExcelHandler, middleware ...gin.HandlerFunc) {
	// Apply middleware to the group if provided
	tx := r.Group("excel", middleware...)
	{
		tx.POST("/import/co-accounts", h.ImportCoAccounts)
...
func SetupRoutes(rg *gin.RouterGroup, h *ExcelHandler, middleware ...gin.HandlerFunc) {
